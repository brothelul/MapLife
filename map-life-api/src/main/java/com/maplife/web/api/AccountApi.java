...
public class AccountApi {
    ...
    private void userLogin(WxUserBo wxUserBo){
        User wxUser = wxService.getUserInfo(wxUserBo);
        String wxOpenId = wxUser.getWxOpenId();
    ...
    public JsonEntity<Map<String, String>> wxLoginAs(@RequestBody TestUserBo testUserBo, HttpServletRequest request){
        String env = sysConfigService.getConfigValue(SystemConstant.APP_MAP_LIFE, SystemConstant.ENV);
        if (!SystemConstant.MAP_LIFE_ENV.equals(env)){
